"""
Django settings for RooBeRooTicket project.
...
SECRET_KEY = 'django-insecure-#1y&bp=9ih$ca_!%(z287@&_=@@7)r@gwhdsdop*z+gj+rmlo8'
...
ROOT_URLCONF = 'RooBeRooTicket.urls'
...
TEMPLATES = [
    {
        ...
        'DIRS': [TEMP_DIR], #add templates folder
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
# make project ready to use html rendering
STATIC_URL = '/assets/'
STATICFILES_DIRS=(
